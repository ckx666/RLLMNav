...
(3) If one area contains nothing, it is still possible that the goal is in that area. Give a score of 0.5. Score the area higher in that case when other areas are not likely to contain the goal.
